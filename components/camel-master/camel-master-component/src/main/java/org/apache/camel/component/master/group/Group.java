...
public interface Group<T extends NodeState> extends Closeable {
     ...
     */
    void add(GroupListenerStrategy<T> listener);

    /**
     * Removes a previously added listener.
     */
    void remove(GroupListenerStrategy<T> listener);
     ...
     * as a {@link #add(GroupListenerStrategy) listener} but wants to retrieve the last state to be up to date when the
     * client is added.
     *
